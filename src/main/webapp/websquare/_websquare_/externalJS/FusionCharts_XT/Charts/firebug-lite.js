...
}}catch(exc){console.log(exc)}return keys
};
...
}catch(exc){console.log(exc);}}}this.EventCopy=EventCopy;
...
}}}catch(e){console.log(e);}focusCommandLineState=++focusCommandLineState%2
}});
...
}catch(e){console.log(e);}}return oldSizzle(query,context,extra,seed)
};
...
}}}}catch(exc){console.log(exc);}return props
...
}catch(exc){console.log(exc);}},supportsObject:function(object,type){return(object instanceof Ci.nsIDOMHistory)
}});
...
}}}catch(exc){console.log(exc);}currentEditor.hide();
...
}catch(exc){console.log(exc);}return false
...
}}catch(exc){console.log(exc);}}var updateHttpSpyInfo=function updateHttpSpyInfo(spy,logRow){if(!spy.logRow&&logRow){spy.logRow=logRow
...
}}catch(exc){console.log(exc);}return nodes
};
...
}}catch(exc){console.log(exc);}if(isFunction(ob)){return true
}return false
};
