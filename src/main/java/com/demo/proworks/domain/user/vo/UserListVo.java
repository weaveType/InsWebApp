...
public class UserListVo extends com.demo.proworks.cmmn.ProworksCommVO {
    ...
    @ElDtoField(logicalName = "일반유저List", physicalName = "userVoList", type = "com.demo.proworks.domain.user.UserVo", typeKind = "List", fldYn = "", length = 0, dotLen = 0, baseValue = "", desc = "")
