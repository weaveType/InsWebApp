...
//        return currentCompanyId != null && currentCompanyId.equals(companyId);
    ...
    public Map<String, Object> selectListPostByMbti(PostMatchVo postMatchVo) throws Exception {
    	System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> : 여기로 요청옴");
        List<PostMatchVo> postList = postService.findPostsByMbti(postMatchVo);      
               // 수정해야됨            
