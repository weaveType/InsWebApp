...
CREATE TABLE EMP
(
EMPNO    INTEGER(4)   NOT NULL     COMMENT '社員番号',
...
SAL      DECIMAL(7,2) DEFAULT NULL COMMENT '給与',
COMM     DECIMAL(7,2) DEFAULT NULL COMMENT '賞与',
DEPTNO   INTEGER(2)   DEFAULT NULL COMMENT '部署番号',
...
CREATE TABLE DEPT (
DEPTNO INTEGER(2)  NOT NULL     COMMENT '部署番号',
DNAME  VARCHAR(14) DEFAULT NULL COMMENT '部署名',
LOC    VARCHAR(13) DEFAULT NULL COMMENT '部署の場所',
  PRIMARY KEY (DEPTNO),
...
Insert into EMP
 ...
 Values
(1111, 'Honggildong', '総務', 22, STR_TO_DATE('2012-01-02 00:00:00', '%Y-%m-%d %H:%i:%s'), 5555, 10);
Insert into EMP
   (EMPNO, ENAME, JOB, MGR, HIREDATE, SAL, DEPTNO)
 Values
